    ...
    let result = tasks
        ...
        .map(|record| {
            ...
            let resolved_entity = match entity {
                lakekeeper::service::tasks::TaskEntity::Project => ResolvedTaskEntity::Project,
                lakekeeper::service::tasks::TaskEntity::Warehouse { warehouse_id } => {
                    warehouse_id.into()
                }
                lakekeeper::service::tasks::TaskEntity::EntityInWarehouse {
                    warehouse_id,
                    entity_id,
                    entity_name,
                } => {
