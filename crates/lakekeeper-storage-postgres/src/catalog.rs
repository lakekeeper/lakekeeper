...
use lakekeeper::{
    ...
    service::{
        ...
        CreateViewError, DropGenericTableError, DropTabularError, EnsureWarehouseSpecMutableError,
        ...
        GetTaskDetailsError, ListGenericTablesError, ListNamespacesQuery, ListRoleMembersResult,
        ...
        RemoveRoleMembersError, RemoveRoleMembersResult, RenameTabularError, ResolveTasksError,
        ResolvedTask, ResolvedWarehouse, Result, Role, RoleId, RoleIdent, RoleMembershipDirection,
        ...
        WarehouseFormatVersionPolicy, WarehouseId, WarehouseStatus, WarehouseStorage,
        authn::UserId,
...
impl CatalogStore for super::PostgresBackend {
    ...
    where
        ...
        'a: 'b,
    {
        use lakekeeper::service::StateOrTransactionEnum;
    ...
    async fn create_roles_impl<'a>(
        ...
        on_conflict: lakekeeper::service::OnRoleConflict,
        transaction: <Self::Transaction as Transaction<Self::State>>::Transaction<'a>,
    ...
    async fn delete_roles_impl<'a>(
        project_id: Option<&ProjectId>,
        filter: lakekeeper::service::CatalogListRolesByIdFilter<'_>,
        transaction: <Self::Transaction as Transaction<Self::State>>::Transaction<'a>,
    ...
    async fn load_generic_table_by_id_impl<'a>(
        warehouse_id: WarehouseId,
        generic_table_id: lakekeeper::service::GenericTableId,
        transaction: <Self::Transaction as Transaction<Self::State>>::Transaction<'a>,
    ) -> std::result::Result<GenericTableInfo, LoadGenericTableError> {
