use lakekeeper::{
    api::ErrorModel,
    service::{
        authz::{AuthorizationBackendUnavailable, AuthzBackendOrValidationError, IsAllowedActionError},
...
impl From<OpenFGABackendUnavailable> for AuthzBackendOrValidationError {
