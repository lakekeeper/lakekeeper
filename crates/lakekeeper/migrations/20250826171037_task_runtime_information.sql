...
CREATE INDEX task_warehouse_queue_created_at_idx ON task (warehouse_id, queue_name, created_at DESC);
...
CREATE INDEX task_log_warehouse_id_entity_type_entity_id_idx ON task_log USING btree (
    warehouse_id,
    entity_type,
    entity_id,
...
CREATE INDEX task_log_warehouse_created_at_id_attempt_idx ON task_log (warehouse_id, task_created_at DESC);

CREATE INDEX task_log_warehouse_queue_created_at_idx ON task_log (warehouse_id, queue_name, task_created_at DESC);
