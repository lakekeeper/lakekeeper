...
alter table task_config drop constraint if exists task_config_pkey;
...
alter table task drop constraint if exists task_unique_warehouse_id_entity_type_entity_id_queue_name;
