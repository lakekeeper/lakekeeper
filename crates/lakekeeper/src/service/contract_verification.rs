...
///     use service::{TabularId, contract_verification::{ContractVerification, ContractVerificationOutcome}};
///     use iceberg_ext::catalog::rest::{ErrorModel, ViewUpdate};
///
///     #[derive(Debug)]
...
impl ContractVerificationOutcome {
    ...
    ///
    /// ```rust
    ///     use service::contract_verification::ContractVerificationOutcome;
