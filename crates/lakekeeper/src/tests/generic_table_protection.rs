...
async fn make_ns_with_profile(
    pool: PgPool,
    delete_profile: crate::api::management::v1::warehouse::TabularDeleteProfile,
) -> (TestApiContext, String, String, crate::WarehouseId) {
...
async fn make_ns(pool: PgPool) -> (TestApiContext, String, String, crate::WarehouseId) {
...
async fn test_soft_delete_protected_generic_table_without_force_fails(pool: PgPool) {
    let (ctx, prefix, ns_name, warehouse_id) = make_ns_with_profile(
        pool,
        crate::api::management::v1::warehouse::TabularDeleteProfile::Soft {
