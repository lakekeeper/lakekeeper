...
#[openapi(
    ...
    paths(
        ...
        super::get_dataset_actions,
        super::list_dataset_grants,
        super::apply_dataset_grants,
        super::get_dataset_grantable_privileges,
        super::set_dataset_tag,
        super::delete_dataset_tag,
        super::list_dataset_tags,
        super::get_dataset_protection,
        super::set_dataset_protection,
