...
generate_endpoints! {
    ...
    enum ManagementV1 {
        ...
        CreateRoleAssignment(POST, "/management/v1/role-assignments"),
        ListRoleAssignments(GET, "/management/v1/role-assignments"),
        DeleteRoleAssignment(DELETE, "/management/v1/role-assignments/{user_id}/{role_id}"),
