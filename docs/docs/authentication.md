...
If you are using Google Cloud Platform, please consider bringing this to the attention of your sales representative. Upvote any of the following Issues: [912693](https://www.googlecloudcommunity.com/gc/Developer-Tools/Authorization-Code-Flow-without-client-secret/m-p/912693#M3618), [33416](https://www.googlecloudcommunity.com/gc/Apigee/Supporting-OAuth-quot-Public-quot-clients-in-authorization-code/m-p/33416), and sent a link of [stackoverflow](https://stackoverflow.com/questions/60724690/using-google-oidc-with-code-flow-and-pkce) and [a github issue](https://github.com/authts/oidc-client-ts/issues/152).

Due to the above limitations of the Google Identity Platform with regard to OAuth2, we do not recommend the use of the Google Identity Platform for productive deployments. Now, let's get going:
